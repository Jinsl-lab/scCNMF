...
RcppExport SEXP _scCNMF_CppoperationMA_demo(SEXP MSEXP, SEXP ASEXP, SEXP typeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(CppoperationMA_demo(M, A, type));
    return rcpp_result_gen;
END_RCPP
}
// ifzeroMCPP
Eigen::MatrixXd ifzeroMCPP(Eigen::MatrixXd M);
RcppExport SEXP _scCNMF_ifzeroMCPP(SEXP MSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Eigen::MatrixXd >::type M(MSEXP);
    rcpp_result_gen = Rcpp::wrap(ifzeroMCPP(M));
    return rcpp_result_gen;
END_RCPP
}
// chooesVinMCPP
Eigen::MatrixXd chooesVinMCPP(const Eigen::MatrixXd& M, const Rcpp::NumericVector& A, int type);
RcppExport SEXP _scCNMF_chooesVinMCPP(SEXP MSEXP, SEXP ASEXP, SEXP typeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< int >::type type(typeSEXP);
    rcpp_result_gen = Rcpp::wrap(chooesVinMCPP(M, A, type));
    return rcpp_result_gen;
END_RCPP
}
// epsMCpp
Eigen::MatrixXd epsMCpp(Eigen::MatrixXd M);
RcppExport SEXP _scCNMF_epsMCpp(SEXP MSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Eigen::MatrixXd >::type M(MSEXP);
    rcpp_result_gen = Rcpp::wrap(epsMCpp(M));
    return rcpp_result_gen;
END_RCPP
}
// Cvar
double Cvar(NumericVector AA, double Mean, int length);
RcppExport SEXP _scCNMF_Cvar(SEXP AASEXP, SEXP MeanSEXP, SEXP lengthSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(Cvar(AA, Mean, length));
    return rcpp_result_gen;
END_RCPP
}
// Cttest
double Cttest(NumericVector A, NumericVector B, NumericVector AA, NumericVector BB, int lengthA, int lengthB);
RcppExport SEXP _scCNMF_Cttest(SEXP ASEXP, SEXP BSEXP, SEXP AASEXP, SEXP BBSEXP, SEXP lengthASEXP, SEXP lengthBSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type A(ASEXP);
    ...
    Rcpp::traits::input_parameter< int >::type lengthA(lengthASEXP);
    Rcpp::traits::input_parameter< int >::type lengthB(lengthBSEXP);
    rcpp_result_gen = Rcpp::wrap(Cttest(A, B, AA, BB, lengthA, lengthB));
    return rcpp_result_gen;
END_RCPP
}
// scCNMF_cpp_function
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_scCNMF_CppoperationMA_demo", (DL_FUNC) &_scCNMF_CppoperationMA_demo, 3},
    {"_scCNMF_ifzeroMCPP", (DL_FUNC) &_scCNMF_ifzeroMCPP, 1},
    {"_scCNMF_chooesVinMCPP", (DL_FUNC) &_scCNMF_chooesVinMCPP, 3},
    {"_scCNMF_epsMCpp", (DL_FUNC) &_scCNMF_epsMCpp, 1},
    {"_scCNMF_Cvar", (DL_FUNC) &_scCNMF_Cvar, 3},
    {"_scCNMF_Cttest", (DL_FUNC) &_scCNMF_Cttest, 6},
